...
const { Component,Button,Styles, View, Text, ScrollView} = React;
...
class TabBar extends Component{
  ...
  _renderIndicator = (props) => {
    ...
    let style = { width, transform: [{ translateX }] }
    return (
      <Animated.View
        style={[
          styles.indicator,
  ...
  _getMaxScrollableDistance = (props) => {
    const { layout, navigationState } = props;
    if (layout.width === 0) {
      return 0;
    }
  ...
  render() {
   ...
   let style = {width: tabBarWidth, transform: [{ translateX }]};
    return (
