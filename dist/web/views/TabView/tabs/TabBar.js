...
var TabBar = function (_Component) {
  ...
  _createClass(TabBar, [{
    ...
    value: function render() {
      ...
      var translateX = Animated.add(position.interpolate({
      ...
      var style = { width: tabBarWidth, transform: [{ translateX: translateX }] };
      return React.createElement(
        ...
        React.createElement(
          ...
          {
            pointerEvents: 'none',
            style: [styles.indicatorContainer, scrollEnabled ? style : null]
          },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            routes.map(function (route, i) {
              ...
              var opacity = Animated.multiply(_this3.state.visibility, position.interpolate({
                inputRange: inputRange,
              ...
              var passedTabStyle = StyleSheet.flatten(_this3.props.tabStyle);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._renderIndicator = function (props) {
    ...
    var translateX = Animated.multiply(Animated.multiply(position, width),
    /*I18nManager.isRTL ? -1 : */1);
    var style = { width: width, transform: [{ translateX: translateX }] };
    return React.createElement(Animated.View, {
      style: [styles.indicator, style, _this4.props.indicatorStyle]
    });
  };
  ...
  this._getTabWidthFromStyle = function (style) {
    ...
    var passedTabStyle = StyleSheet.flatten(_this4.props.tabStyle);
    var cache = {
      style: style,
  ...
  this._resetScrollOffset = function (props) {
    ...
    Animated.timing(_this4.state.offset, {
      toValue: 0,
      duration: 150
    }).start();
  };
  ...
  this._adjustOffset = function (value) {
    ...
    if (_this4._isMomentumScroll) {
      Animated.spring(_this4.state.offset, {
