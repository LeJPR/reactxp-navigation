...
var TabView = function (_Component) {
  ...
  function TabView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabView.__proto__ || Object.getPrototypeOf(TabView)).call.apply(_ref, [this].concat(args))), _this), _this._handlePageChanged = function (index) {
      ...
      return React.createElement(_tabs.TabViewPagerPan, props);
  ...
  _createClass(TabView, [{
    ...
    value: function render() {
      ...
      return React.createElement(_tabs.TabViewAnimated, props);
    }
  }]);
...
var TabViewEnhanced = withCachedChildNavigation(TabView);
